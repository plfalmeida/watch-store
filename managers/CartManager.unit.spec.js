...
import CartManagerPlugin, { CartManager } from '@/managers/CartManager';
...
describe('CartManager', () => {
  ...
  it('should install plugin correctly', () => {
    ...
    localVue.use(CartManagerPlugin);

    const wrapper = mount(DefaultLayout, { localVue, stubs: { Nuxt: true } });

    expect(wrapper.vm.$cart).toBeDefined();
    expect(wrapper.vm.$cart).toBeInstanceOf(CartManager);
  });
});
